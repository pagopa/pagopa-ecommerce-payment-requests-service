...
import it.pagopa.ecommerce.payment.requests.configurations.redis.RedisConfiguration
...
class OpenTelemetryConfigurationTests {
    ...
    fun `Should get tracer instance`() {
        ...
        Assertions.assertEquals(tracer, openTelemetry.getTracer("pagopa-ecommerce-payment-requests-service"))
    }
